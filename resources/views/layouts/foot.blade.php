<!-- Vendor -->
    ...
    <script src="{{ asset('js/one-page-nav.js?v='.rand()) }}"></script>
    ...
    <script src="{{ asset('js/all-js-libraries.js?v='.rand()) }}"></script>
    <script src="js/all-js-libraries.js"></script>
    <script src="{{ asset('js/active.js?v='.rand()) }}"></script>
    <script src="js/active.js"></script>
    <script src="{{ asset('js/jquery/jquery-2.2.4.min.js?v='.rand()) }}"></script>
